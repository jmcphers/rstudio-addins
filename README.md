...
| Word Count | Show word count and readability stats for current R Markdown document | [wordcountaddin](https://github.com/benmarwick/wordcountaddin) | :x: | [Ben Marwick](http://faculty.washington.edu/bmarwick/) | [Demo video](https://raw.githubusercontent.com/benmarwick/wordcountaddin/master/inst/wordcountaddin.gif) | |
